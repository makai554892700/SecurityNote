...
public class AddressFragment extends BaseNoteFragment<BaseRealNode> {
    ...
    public void initData(int page) {
        if (page == 0) {
            ArrayList<BaseRealNode> baseRealNodes = DataUtils.getResultData().get(BaseRealNode.Type.ADDRESS);
    ...
    protected void initView(View view) {
        recyclerAdapter = new AddressAdapter(getContext());
    }
}
