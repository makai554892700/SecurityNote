...
import www.mys.com.security.node.adapter.CreditCardAdapter;
...
public class CreditCardFragment extends BaseNoteFragment<BaseRealNode> {
    ...
    public void initData(int page) {
        if (page == 0) {
            ArrayList<BaseRealNode> baseRealNodes = DataUtils.getResultData().get(BaseRealNode.Type.CREDIT_CARD);
    ...
    protected void initView(View view) {
        recyclerAdapter = new CreditCardAdapter(getContext());
    }
}
