...
import www.mys.com.security.node.adapter.ReceiptAdapter;
...
public class ReceiptFragment extends BaseNoteFragment<BaseRealNode> {
    ...
    public void initData(int page) {
        if (page == 0) {
            ArrayList<BaseRealNode> baseRealNodes = DataUtils.getResultData().get(BaseRealNode.Type.RECEIPT);
    ...
    protected void initView(View view) {
        recyclerAdapter = new ReceiptAdapter(getContext());
    }
}
